package edu.cuny.brooklyn.cisc3120.demo;
...
public class CmdLineArgsDemo 
{
    public static void main( String[] args )
    {
    	...
    	options.addOption( Option.builder("s")
						    			.longOpt( "small" )
						                .desc( "emphasize small files whose size is less a threshold" )
						                .hasArg()
						                .argName("SIZE THRESHOLD")
						                .build() );
    	options.addOption( Option.builder("u")
                .desc( "emphasize files beloning to a given user" )
                .hasArg()
                .argName("USER ID")
                .build() );    	
    	...
    	try {
    	    ...
    	    if (line.hasOption( "help") ) {
    	        ...
    	        System.out.println("The value of command line argument \"block-size\" is " 
